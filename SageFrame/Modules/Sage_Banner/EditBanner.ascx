                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <CKEditor:CKEditorControl ID="txtBannerDescriptionToBeShown" runat="server" Height="150px"
                                    TextMode="MultiLine" Width="" meta:resourcekey="txtBannerDescriptionToBeShownResource1"></CKEditor:CKEditorControl>
                            </td>
                        </tr>
                        <tr>
                            <td>
...
<asp:Panel ID="pnlBannerList" runat="server" meta:resourcekey="pnlPageListResource1"
    ...
    <table cellpadding="0" cellspacing="0" width="100%">
        <tr>
            <td width="20%">
                <asp:Label ID="lblBannerName" runat="server" CssClass="sfFormlabel" meta:resourcekey="lblBannerNameResource1">Banner Name</asp:Label>
            </td>
            <td width="30">
                :
            </td>
        ...
        <tr style="display: none">
            <td>
                <asp:Label ID="lblBannerDescription" runat="server" CssClass="sfFormlabel" meta:resourcekey="lblBannerDescriptionResource1">Description</asp:Label>
            </td>
            <td>
...
<div id="divImageEditor" runat="server" style="display: none;" class="sfFormwrapper">
    <div class="cssClassFormHeading">
        <asp:Label ID="lblCropArea" runat="server" CssClass="sfFormlabel" meta:resourcekey="lblCropAreaResource1"> Drag on the image area to crop the image:</asp:Label>
    </div>
    <div>
