...
//            alert($('.ui-dialog-titlebar-maximize.ui-corner-all').length);
//            $('.ui-dialog-titlebar-maximize.ui-corner-all').trigger('click');
//        }, 3000);
                ...
                <div class="sfCenterWrapper">
                    <div class="sfCenter">
                        <div class="sfQuicklink">
                            ...
                            <div id="trPages">
                                <h4 id="lblChoosePage" class="clearfix">
                                    <span>Choose Pages &nbsp;<i class="icon-info" data-title="List of pages that you can include in the menu "></i></span>
                                </h4>
