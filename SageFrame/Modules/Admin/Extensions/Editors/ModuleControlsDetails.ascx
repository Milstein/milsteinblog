    ...
    <ContentTemplate>
        <div class="sfCollapsewrapper sfFormwrapper">
            <div id="divModuleControlSetting" runat="server" class="sfCollapsecontent">
                <div class="sfMarginTopPri">
                    ...
                    <p class="sfNote">
                        <asp:Label ID="lblModuleControlSettingsHelp" runat="server" Text="In this section, you can set up more advanced settings for Module Controls on this Module." meta:resourcekey="lblModuleControlSettingsHelpResource1"></asp:Label>
                    </p>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr id="rowModuleEdit" runat="server" visible="False">
                            <td width="20%" runat="server">
                                <asp:Label ID="lblModuleEdit" runat="server" Text="Module" CssClass="sfFormlabel"></asp:Label></td>

                            <td runat="server">
                                <asp:Label ID="lblModuleD" runat="server"></asp:Label></td>
                        </tr>
                        <tr id="rowDefinitionEdit" runat="server" visible="False">
                            <td runat="server">
                                <asp:Label ID="lblDefinitionEdit" runat="server" Text="Definition" CssClass="sfFormlabel"></asp:Label></td>

                            <td runat="server">
                                <asp:Label ID="lblDefinitionD" runat="server"></asp:Label></td>
                        </tr>
                        <tr id="rowSource" runat="server" visible="False">
                            <td runat="server">
                                <asp:Label ID="lblSource" runat="server" Text="Source" CssClass="sfFormlabel"></asp:Label></td>
                        ...
                        <tr>
                            <td width="20%">
                                <asp:Label ID="lblKey" runat="server" Text="Key" CssClass="sfFormlabel" meta:resourcekey="lblKeyResource1"></asp:Label></td>

                            <td>
                                <asp:TextBox ID="txtKey" runat="server" CssClass="sfInputbox" meta:resourcekey="txtKeyResource1"></asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtTitle" runat="server" CssClass="sfInputbox" meta:resourcekey="txtTitleResource1"></asp:TextBox>
                        ...
                        <tr id="rowDisplayOrder" runat="server" visible="False">
                            <td runat="server">
                                <asp:Label ID="lblDisplayOrder" runat="server" Text="Display Order" CssClass="sfFormlabel"></asp:Label></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlIcon" runat="server" CssClass="sfListmenu" meta:resourcekey="ddlIconResource1" /></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <asp:RegularExpressionValidator ID="revHelpUrl" runat="server" ControlToValidate="txtHelpURL"
                                    ...
                                    ValidationExpression="^(([\w]+:)?\/\/)?(([\d\w]|%[a-fA-f\d]{2,2})+(:([\d\w]|%[a-fA-f\d]{2,2})+)?@)?([\d\w][-\d\w]{0,253}[\d\w]\.)+[\w]{2,4}(:[\d]+)?(\/([-+_~.\d\w]|%[a-fA-f\d]{2,2})*)*(\?(&amp;?([-+_~.\d\w]|%[a-fA-f\d]{2,2})=?)*)?(#([-+_~.\d\w]|%[a-fA-f\d]{2,2})*)?$" meta:resourcekey="revHelpUrlResource1"></asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:CheckBox ID="chkSupportsPartialRendering" runat="server"
                                    CssClass="sfCheckbox" meta:resourcekey="chkSupportsPartialRenderingResource1" /></td>
                        </tr>
                    </table>
                </div>
            </div>
        ...
        <div runat="server" id="pUpdatePane" visible="False"
            ...
            <asp:LinkButton ID="imbUpdateModlueControl" runat="server" CssClass="icon-save sfBtn"
                ...
                Text="Save" meta:resourcekey="imbUpdateModlueControlResource1" />
            <asp:LinkButton ID="imbCancelModlueControl" runat="server" CausesValidation="False" Text="Cancel"
                OnClick="imbCancelModlueControl_Click" CssClass="icon-close sfBtn" meta:resourcekey="imbCancelModlueControlResource1" />
        </div>
    </ContentTemplate>
</asp:UpdatePanel>
