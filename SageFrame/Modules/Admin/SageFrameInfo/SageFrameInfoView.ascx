...
<div class="sfInformation">
    <div class="sfInformationholder">
        <div class="sfInformationheader Curve">
            <h2 class="Curve">Welcome to Sageframe</h2>
        </div>
    ...
    <div class="sfInformationholder">
        <div class="sfInformationheader Curve">
            <h2 class="Curve">SageFrame Tutorials</h2>
        </div>
        <div class="sfInformationcontent sfTutorialContent">
            <div class="sfLivefeed">
                <ul>
                    <li><a target="new" href="http://www.sageframe.com/Resources/Tutorials.aspx?RSS=Blog&amp;blogid=14">Document Library</a></li>
                    <li><a target="new" href="http://www.sageframe.com/Resources/Tutorials.aspx?RSS=Blog&amp;blogid=13">How to create a module on SageFrame</a></li>
                </ul>
            </div>
            <br>
            <a target="_blank" href="http://www.sageframe.com/Tutorials.aspx">More Tutorials..</a>
        </div>
    </div>
    <div class="sfInformationholder">
        <div class="sfInformationheader Curve">
            <h2 class="Curve">SageFrame News Feed</h2>
        </div>
        <div class="sfInformationcontent sfnewsContent">
            <div class="sfLivefeed">
                <ul>
                    <li><a target="new" href="http://www.sageframe.com/MoreNews.aspx?RSS=news&amp;newscode=42">Revising SageFrame Templating</a></li>
                    <li><a target="new" href="http://www.sageframe.com/MoreNews.aspx?RSS=news&amp;newscode=41">SAGEFRAME FULL VERSION RELEASED!</a></li>
                    <li><a target="new" href="http://www.sageframe.com/MoreNews.aspx?RSS=news&amp;newscode=37">Upgraded from Alpha to Beta Version Successfully</a></li>
                    <li><a target="new" href="http://www.sageframe.com/MoreNews.aspx?RSS=news&amp;newscode=38">SageFrame Features coming soon</a></li>
                    <li><a target="new" href="http://www.sageframe.com/MoreNews.aspx?RSS=news&amp;newscode=39">SageFrame Beta Testing</a></li>
                </ul>
            </div>
            <br>
            <a target="_blank" href="http://www.sageframe.com/MoreNews.aspx">More News..</a>
        </div>
    </div>
    <div class="sfInformationholder">
        <div class="sfInformationheader Curve ">
            <h2 class="Curve">SageFrame Module List</h2>
        </div>
        <div class="sfInformationcontent moduleList">
            <div class="wrapperResult">
                <div>
                    ...
                    <a href="www.braindigit.com">Download</a>
                </div>
                <div>
                    <label>
    ...
    <div class="sfInformationholder">
        <div class="sfInformationheader Curve">
            <h2 class="Curve">SageFrame Blog</h2>
        </div>
        <div class="sfInformationcontent sfblogContent">
            <div class="sfLivefeed">
                <ul>
                    <li><a target="new" href="http://www.sageframe.com/Blog.aspx?RSS=Blog&amp;blogid=15">Developing a website with SageFrame - The dynamic Asp.Net CMS</a></li>
                    <li><a target="new"
                        href="http://www.sageframe.com/Blog.aspx?RSS=Blog&amp;blogid=12">How to create a
                            module on SageFrame</a></li>
                    <li><a target="new" href="http://www.sageframe.com/Blog.aspx?RSS=Blog&amp;blogid=11">A website in SageFrame</a></li>
                    <li><a target="new" href="http://www.sageframe.com/Blog.aspx?RSS=Blog&amp;blogid=10">SageFrame Installation Guide for Windows7</a></li>
                    <li><a target="new" href="http://www.sageframe.com/Blog.aspx?RSS=Blog&amp;blogid=9">Installing Sageframe Visual Studio (VS) Template and Module Starter Kit</a></li>
                </ul>
            </div>
            <br>
            <a target="_blank" href="http://www.sageframe.com/Blog.aspx">More Blogs..</a>
        </div>
    </div>
</div>
