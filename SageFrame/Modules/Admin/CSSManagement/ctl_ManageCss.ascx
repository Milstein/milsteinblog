...
<div class="sfFormwrapper sfPadding">
    <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td width="10%">
                <asp:Label ID="lblCSSFile" runat="server" Text="CSS File" CssClass="sfFormlabel" meta:resourcekey="lblCSSFileResource1"></asp:Label>
            </td>
            <td width="5%">:
            </td>
            <td>
                <asp:DropDownList ID="ddlCssFileList" runat="server" CssClass="sfListmenu" AutoPostBack="True"
                    OnSelectedIndexChanged="ddlCssFileList_SelectedIndexChanged" ValidationGroup="ValidateCssManagement" meta:resourcekey="ddlCssFileListResource1">
                </asp:DropDownList>
        ...
        <tr>
            <td valign="top">
                <asp:Label ID="lblFileContent" runat="server" Text="File Content" CssClass="sfFormlabel" meta:resourcekey="lblFileContentResource1"></asp:Label>
            </td>
            <td valign="top">:
            </td>
            <td>
                <asp:TextBox ID="txtFileContent" runat="server" TextMode="MultiLine" Columns="200"
                    ...
                    Height="300px" meta:resourcekey="txtFileContentResource1"></asp:TextBox>
...
<div class="sfButtonwrapper">
    ...
    <asp:Label ID="lblSave" runat="server" AssociatedControlID="imbSave" Text="Save" meta:resourcekey="lblSaveResource1"></asp:Label>
    <asp:ImageButton ID="imbRefresh" runat="server" ToolTip="Refresh" OnClick="imbRefresh_Click" meta:resourcekey="imbRefreshResource1" />
    <asp:Label ID="lblRefresh" runat="server" AssociatedControlID="imbRefresh" Text="Refresh" meta:resourcekey="lblRefreshResource1"></asp:Label>
