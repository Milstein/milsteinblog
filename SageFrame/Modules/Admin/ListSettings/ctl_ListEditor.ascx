        ...
        <div class="sfListright">
            <asp:Panel ID="pnlListAll" Visible="False" runat="server" meta:resourcekey="pnlListAllResource1">
                <div class="sfButtonwrapper sfMargintopnone">
                    <label class="sfLocale icon-addnew sfBtn">
                        Add List Item
                        <asp:Button ID="imgAddList1" runat="server" OnClick="imgAddSubList_Click" ToolTip="Add List" meta:resourcekey="imgAddList1Resource1" /></label>
                    <label class="sfLocale icon-delete sfBtn">
                        ...
                        <asp:Button ID="imgDeleteList" runat="server" OnClick="imgDeleteList_Click"
                            OnClientClick="if(confirm('Are you sure you want to delete?')!=true)return false;" ToolTip="Delete List" meta:resourcekey="imgDeleteListResource1" />
                    </label>
                ...
                <div class="sfGridwrapper sfListing curve sfTableOption">
                    <table cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr class="sfEven">
                            <td>
                                <asp:Label ID="lblListNameLabel" runat="server" CssClass="sfFormlabel" Text="List Name :" meta:resourcekey="lblListNameLabelResource1"></asp:Label>
                ...
                <asp:Panel ID="pnlViewList" Visible="False" runat="server" meta:resourcekey="pnlViewListResource1">
                    ...
                    <div class="sfGridwrapper">
                        <asp:GridView ID="gdvSubList" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvSubList_RowCommand"
                            ...
                            OnRowDataBound="gdvSubList_RowDataBound" Width="100%" AllowPaging="True" OnPageIndexChanging="gdvSubList_PageIndexChanging" meta:resourcekey="gdvSubListResource1">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField meta:resourcekey="TemplateFieldResource1">
                                    <ItemTemplate>
                                        <div class="sfMoveNS">
                                            <asp:LinkButton ID="imgListUp" runat="server" CausesValidation="False" CommandArgument='<%# Eval("EntryID") %>' CommandName="SortUp" CssClass="icon-arrow-n" ToolTip="Move Up" meta:resourcekey="imgListUpResource1"></asp:LinkButton>
                                            <asp:LinkButton ID="imgListDown" runat="server" CausesValidation="False" CommandArgument='<%# Eval("EntryID") %>' CommandName="SortDown" CssClass="icon-arrow-s" ToolTip="Move Down" meta:resourcekey="imgListDownResource1"></asp:LinkButton>
                                        </div>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField meta:resourcekey="TemplateFieldResource2">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="imgEdit" runat="server" CausesValidation="False" CommandArgument='<%# Eval("EntryID") %>' CommandName="Edit" CssClass="icon-edit" ToolTip="Edit" meta:resourcekey="imgEditResource1"></asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle CssClass="sfEdit" />
                                </asp:TemplateField>
                                <asp:TemplateField meta:resourcekey="TemplateFieldResource3">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="imgDelete" runat="server" CausesValidation="False" CommandArgument='<%# Eval("EntryID") %>' CommandName="Delete" CssClass="icon-delete" ToolTip="Delete" meta:resourcekey="imgDeleteResource1"></asp:LinkButton>
                                    </ItemTemplate>
            ...
            <asp:Panel ID="pnlAddList" Visible="False" CssClass="sfFormwrapper" runat="server" meta:resourcekey="pnlAddListResource1">
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    <tr id="trListName" runat="server">
                        <td width="30%" runat="server">
                            <asp:Label ID="lblListNameText" runat="server" CssClass="sfFormlabel" Text="List Name"></asp:Label>
                        </td>
                        <td width="30" id="tdListName" runat="server">:
                        </td>
                        <td runat="server">
                            <asp:TextBox ID="txtListName" runat="server" CssClass="sfInputbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="trParentList" runat="server">
                        <td runat="server">
                            <asp:Label ID="lblParentListText" runat="server" CssClass="sfFormlabel" Text="Parent List"></asp:Label>
                        </td>
                    ...
                    <tr id="trParentEntry" runat="server">
                        <td runat="server">
                            <asp:Label ID="lblParentEntryText" runat="server" CssClass="sfFormlabel" Text="Parent Entry"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblEntryText" CssClass="sfFormlabel" Text="Entry Text" runat="server" meta:resourcekey="lblEntryTextResource1" />
                        </td>
                        <td width="30">:
                        </td>
                        <td>
                            <asp:TextBox ID="txtEntryText" runat="server" EnableViewState="False" CssClass="sfInputbox" meta:resourcekey="txtEntryTextResource1"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblEntryValue" CssClass="sfFormlabel" Text="Entry Value" runat="server" meta:resourcekey="lblEntryValueResource1" />
                        </td>
                        <td width="30">:
                        </td>
                        <td>
                            <asp:TextBox ID="txtEntryValue" runat="server" EnableViewState="False" CssClass="sfInputbox" meta:resourcekey="txtEntryValueResource1"></asp:TextBox>
                    ...
                    <tr id="trCurrencyCode" runat="server">
                        <td runat="server">
                            <asp:Label ID="lblCurrencyCode" runat="server" CssClass="sfFormlabel" Text="Currency Code"></asp:Label>
                        </td>
                        <td width="30" id="tdCurrencyCode" runat="server">:
                        </td>
                        <td runat="server">
                            <asp:TextBox ID="txtCurrencyCode" runat="server" EnableViewState="False" CssClass="sfInputbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="trDisplayLocale" runat="server">
                        <td runat="server">
                            <asp:Label ID="lblDisplayLocale" runat="server" CssClass="sfFormlabel" Text="Display Locale"></asp:Label>
                        </td>
                        <td width="30" id="tdDisplayLocale" runat="server">:
                        </td>
                        <td runat="server">
                            <asp:TextBox ID="txtDisplayLocale" runat="server" EnableViewState="False" CssClass="sfInputbox"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="trEnableSort" runat="server">
                        <td runat="server">
                            <asp:Label ID="lblSortOrder" runat="server" CssClass="sfFormlabel" Text="Enable Sort Order"></asp:Label>
                        </td>
                        <td width="30" runat="server">:
                        </td>
                        <td runat="server">
                ...
                <div class="sfButtonwrapper">
                    ...
                    <label class="sfLocale icon-close sfBtn">
                        Cancel
                    <asp:Button ID="imgCancel" OnClick="imgCancel_Click" ToolTip="Cancel" runat="server" meta:resourcekey="imgCancelResource1" /></label>
                </div>
            </asp:Panel>
        </div>
    </div>
