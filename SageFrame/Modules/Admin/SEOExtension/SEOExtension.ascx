...
<div>
    <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="" meta:resourcekey="TabContainer1Resource1">
            ...
            <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtvalue" runat="server" TextMode="MultiLine" Rows="10" ValidationGroup="GJSC"
                                    CssClass="sfTextarea sfFullwidth" Height="200px" meta:resourcekey="txtvalueResource1"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvJS" runat="server" ControlToValidate="txtvalue"
                                    ErrorMessage="*" ValidationGroup="GJSC" CssClass="sfError" meta:resourcekey="rfvJSResource1"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            <td valign='top'>
                ...
                <div class="sfButtonwrapper">
                    ...
                    <asp:Button ID="imbSave" runat="server" OnClick="imbSave_Click" ToolTip="Save"
                        CausesValidation="False" ValidationGroup="GJSC" meta:resourcekey="imbSaveResource1" /></label>
        ...
        <cc1:TabPanel ID="tpSitemap" runat="server" HeaderText="Sitemap" meta:resourcekey="tpSitemapResource1">
            <ContentTemplate>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Button ID="BtnGenerateSitemap" runat="server"
                                    OnClick="btnGenerateSitemap_Click" meta:resourcekey="BtnGenerateSitemapResource1" /></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <cc1:TabPanel ID="tpRobots" runat="server" HeaderText="Robots" meta:resourcekey="tpRobotsResource1">
            <ContentTemplate>
                <div id="divRobots">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td>
                                <label class="sfLocale icon-generate sfBtn">
                                    Generate Robots
                                <asp:Button ID="btnGenerateRobots" runat="server" ValidationGroup="checkselected" OnClick="btnGenerateRobots_Click" meta:resourcekey="btnGenerateRobotsResource1"></asp:Button></label>
                            </td>
                        </tr>
                        <td colspan="2">
                            <div class="sfGridwrapper">
                                <asp:GridView ID="gdvRobots" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="Path Not To Crawl" meta:resourcekey="TemplateFieldResource1">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkPath" runat="server" meta:resourcekey="chkPathResource1" />
                                                <asp:Label ID="lblTabPath" runat="server" Text='<%# Eval("TabPath") %>' meta:resourcekey="lblTabPathResource1"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
