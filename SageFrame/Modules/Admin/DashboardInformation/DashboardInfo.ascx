    ...
    <div class="sfTutorialWrap clearfix">
        <ul>
            ...
            <li class="sfTutorialC">
                ...
                <a target="new" href="http://sageframe.com/Documentation.aspx">Document Library</a> <a target="new" href="http://sageframe.com/Developer-Guide.aspx">Developer Guide </a><a href="http://sageframe.com/Video-Gallery.aspx">Video Gallery</a>
            <li class="sfModuleList">
                <h3>SageFrame3.1 Specials</h3>
                <a href="#">Schedular </a>
                <a href="#">Upgrader </a>
