...
<h1>
    <asp:Label ID="lblLanguagePackCreator" runat="server" Text="Language Pack Creator" meta:resourcekey="lblLanguagePackCreatorResource1"></asp:Label>
</h1>
<div class="sfFormwrapper">
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="130">
                <asp:Label runat="server" ID="lblResoucreLocale" CssClass="sfFormlabel"
                    Text="Resource Locale" meta:resourcekey="lblResoucreLocaleResource1"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            <td>
                <asp:Label runat="server" ID="lblResoucrePackType" CssClass="sfFormlabel"
                    Text="Resource Pack Type" meta:resourcekey="lblResoucrePackTypeResource1"></asp:Label>
            </td>
            <td class="sfRadiobutton">
                <asp:RadioButtonList ID="rbResourcePackType" RepeatDirection="Horizontal" runat="server"
                    AutoPostBack="True" OnSelectedIndexChanged="rbResourcePackType_SelectedIndexChanged" meta:resourcekey="rbResourcePackTypeResource1">
        ...
        <tr id="togglingTr" runat="server">
            ...
            <td>
                <div id="divModuleDetails" runat="server" class="cssClassLanguagePackCreaterModule">
                    <p class="sfNote">
                        Please select the modules to include in the language pack
                    </p>
        ...
        <tr>
            <td>
                <asp:Label runat="server" ID="lblResourcePackName" CssClass="sfFormlabel"
                    Text="Resource Pack Name" meta:resourcekey="lblResourcePackNameResource1"></asp:Label>
            </td>
            <td>ResourcePack
                <asp:TextBox ID="txtResourcePackName" runat="server" Width="120px"
                    Text="Core" CssClass="sfInputbox" meta:resourcekey="txtResourcePackNameResource1"></asp:TextBox>
                .&lt;version&gt;.&lt;locale&gt;.zip
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:LinkButton ID="lnkBtnDownloadPackage" runat="server" OnClick="lnkBtnDownloadPackage_Click" meta:resourcekey="lnkBtnDownloadPackageResource1"></asp:LinkButton>
            </td>
        </tr>
    </table>
</div>
<div class="sfButtonwrapper">
    <label class="sfLocale icon-download-package sfBtn">
        Create
    ...
    <label class="sfLocale icon-close sfBtn">
        Cancel
    <asp:Button ID="imbCancel" runat="server" OnClick="imbCancel_Click" ImageUrl="~/Administrator/Templates/Default/images/btncancel.png" meta:resourcekey="imbCancelResource1" />
    </label>
