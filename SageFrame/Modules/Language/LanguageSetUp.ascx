    ...
    <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
            <td width="15%" valign="top">
                <asp:Label ID="lblLanguage" CssClass="sfFormlabel" runat="server" Text="Select Language" meta:resourcekey="lblLanguageResource1"></asp:Label>
            </td>
            <td width="30">:
            </td>
            <td>
                ...
                <div class="sfRadiobutton">
                    <asp:RadioButtonList ID="rbLanguageType" RepeatDirection="Horizontal" runat="server"
                        AutoPostBack="True" OnSelectedIndexChanged="rbLanguageType_SelectedIndexChanged" meta:resourcekey="rbLanguageTypeResource1">
