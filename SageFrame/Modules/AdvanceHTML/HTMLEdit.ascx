    ...
    <ContentTemplate>
        ...
        <div id="divEditWrapper" runat="server" class="cssClassEditWrapper">
            <div class="sfFormwrapper">
                ...
                <div class="sfButtonwrapper">
                    <asp:ImageButton ID="imbSave" runat="server" OnClick="imbSave_Click" ValidationGroup="body" meta:resourcekey="imbSaveResource1" />
                    <asp:Label ID="lblSave" runat="server" Text="Save" AssociatedControlID="imbSave" CssClass="cssClassHtmlViewCursor" meta:resourcekey="lblSaveResource1"></asp:Label>
                </div>
            </div>
        </div>
        ...
        <div id="divViewComment" style="display:none" runat="server" class="cssClassCommentWrapper">
            <div class="cssClassGridWrapper">
                <div class="cssClassHtmlViewComentTable"><asp:GridView ID="gdvHTMLList" runat="server" AutoGenerateColumns="False" Width="100%" GridLines="None"
                        ...
                        <asp:TemplateField meta:resourcekey="TemplateFieldResource1">
                            ...
                            <ItemTemplate>
                                <div class="cssClassCommentBy">
                                    <asp:Label ID="lblAddedBy" runat="server" Text='<%# Eval("AddedBy") + " on " + Eval("AddedOn") + " Says:" %>' meta:resourcekey="lblAddedByResource1" /></div>
