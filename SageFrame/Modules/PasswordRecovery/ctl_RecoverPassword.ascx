...
<div class="sfRecoverPasswordPage" runat="server" id="divRecoverpwd">
    <div class="sfFormwrapper sfLogininside">
        <asp:Wizard ID="wzdPasswordRecover" runat="server" DisplaySideBar="False" ActiveStepIndex="0"
            ...
            OnFinishButtonClick="wzdPasswordRecover_FinishButtonClick" Width="100%" meta:resourcekey="wzdPasswordRecoverResource1">
            ...
            <WizardSteps>
                <asp:WizardStep ID="WizardStep1" runat="server" Title="Setting New Password" meta:resourcekey="WizardStep1Resource1">
                    <%= helpTemplate %>
                            ...
                            <tr>
                                <td>
                                    <asp:Label ID="lblRetypePassword" runat="server" Text="Retype Password"
                                        CssClass="sfFormlabel" MaxLength="20" meta:resourcekey="lblRetypePasswordResource1"></asp:Label></td>
                                <td width="30">:</td>
                                <td>
                                    ...
                                    <asp:CompareValidator ID="cvPassword" runat="server" ErrorMessage="*" CssClass="sfError"
                                        ...
                                        ControlToValidate="txtRetypePassword" ValidationGroup="vdgRecoveredPassword" meta:resourcekey="cvPasswordResource1"></asp:CompareValidator></td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                    <asp:ValidationSummary ID="ValidationSummary1" runat="server"
                                        ValidationGroup="vdgRecoveredPassword" meta:resourcekey="ValidationSummary1Resource1" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
                ...
                <asp:WizardStep ID="WizardStep2" runat="server" Title="Finished Template" meta:resourcekey="WizardStep2Resource1">
                    <asp:Literal ID="litPasswordChangedSuccessful" runat="server" meta:resourcekey="litPasswordChangedSuccessfulResource1"></asp:Literal>
                </asp:WizardStep>
            </WizardSteps>
        </asp:Wizard>
    </div>
