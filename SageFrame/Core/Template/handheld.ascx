<%@ Control Language="C#" ClassName="handheld" %>
<div id='sfOuterWrapper' class="sfCurve" runat="server">
    <div id='sfHeaders' class='sfOuterwrapper clearfix'>
        <div class='sfInnerwrapper clearfix'>
            <div class='sfMoreblocks clearfix'>
                <div id="sfLogo" class='sfCol_46'>
                    <div class='sfWrapper'>
                        <asp:PlaceHolder ID='pch_logo' runat='server'></asp:PlaceHolder>
                    </div>
                </div>
                <div id="sfSearch" class='sfCol_54'>
                    <div class='sfWrapper'>
    ...
    <div id='sfFulltopspan' class='sfOuterwrapper clearfix'>
        <div class='sfInnerwrapper clearfix'>
            <div class='sfMoreblocks clearfix'>
                <div class='sfCol_100'>
                    <div class='sfWrapper'>
                        <asp:PlaceHolder ID='pch_getstarted' runat='server'></asp:PlaceHolder>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class='sfMainContent sfCurve'>
                            ...
                            <div class='sfMiddlemainbottom '>
                                <div class='sfMoreblocks clearfix'>
                                    <div class='sfCol_100'>
                                        <div class='sfWrapper'>
                                            <asp:PlaceHolder ID='pch_whyuse' runat='server'></asp:PlaceHolder>
                                        </div>
                                    </div>
                                </div>
                            </div>
